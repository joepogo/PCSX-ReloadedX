...
typedef long (CALLBACK* GPUopen)(/*HWND*/void);
typedef long (CALLBACK* SPUopen)(/*HWND*/void);
typedef long (CALLBACK* PADopen)(/*HWND*/void);
typedef long (CALLBACK* NETopen)(/*HWND*/void);
typedef long (CALLBACK* SIO1open)(/*HWND*/void);
