...
#ifndef _XBOX // This is only used when "if(dwActFixes & 2)", disabled for now as it's not a necessity and just a game fix
			  // the glPixelZoom fuction missing from our wapper can be implemented latter to re-enable
...
#ifndef _XBOX // Disabled for now as it's not a necessity i.e just a minor fix for some games
			  // the glPixelZoom fuction missing from our wapper can be implemented latter to re-enable
