...
#ifndef _XBOX // We don't need to worry about clearing out
			  // all the reserved the textures with FakeGLx 
 for(i=0;i<MAXSORTTEX;i++)
  {
...
#ifndef _XBOX // bFakeFrontBuffer is not used luckly, 
			  // as we don't have glCopyTexSubImage2D
			  // and glReadBuffer in our wrappers at 
			  // the momment. Prob will never need them
